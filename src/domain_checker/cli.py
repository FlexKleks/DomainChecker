...
DEFAULT_TLDS = [
    ...
    TLDConfig(
        tld="info",
        rdap_endpoint="https://rdap.afilias.net/rdap/info/domain/",
        whois_server="whois.afilias.net",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="biz",
        rdap_endpoint="https://rdap.nic.biz/domain/",
        whois_server="whois.nic.biz",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="io",
        rdap_endpoint="https://rdap.nic.io/domain/",
        whois_server="whois.nic.io",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="co",
        rdap_endpoint="https://rdap.nic.co/domain/",
        whois_server="whois.nic.co",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="app",
        rdap_endpoint="https://rdap.nic.google/domain/",
    ...
    TLDConfig(
        tld="xyz",
        rdap_endpoint="https://rdap.nic.xyz/domain/",
        whois_server="whois.nic.xyz",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="online",
        rdap_endpoint="https://rdap.centralnic.com/online/domain/",
        whois_server="whois.centralnic.com",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="site",
        rdap_endpoint="https://rdap.centralnic.com/site/domain/",
        whois_server="whois.centralnic.com",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="tech",
        rdap_endpoint="https://rdap.centralnic.com/tech/domain/",
        whois_server="whois.centralnic.com",
        whois_enabled=True,
    ),
    # European ccTLDs
    ...
    TLDConfig(
        tld="ch",
        rdap_endpoint="https://rdap.nic.ch/domain/",
        whois_server="whois.nic.ch",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="nl",
        rdap_endpoint="https://rdap.sidn.nl/domain/",
        whois_server="whois.sidn.nl",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="be",
    ...
    TLDConfig(
        tld="fr",
        rdap_endpoint="https://rdap.nic.fr/domain/",
    ...
    TLDConfig(
        tld="pl",
        rdap_endpoint="https://rdap.dns.pl/domain/",
        whois_server="whois.dns.pl",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="se",
        rdap_endpoint="https://rdap.iis.se/domain/",
    ...
    TLDConfig(
        tld="no",
        rdap_endpoint="https://rdap.norid.no/domain/",
    ...
    TLDConfig(
        tld="uk",
        rdap_endpoint="https://rdap.nominet.uk/uk/domain/",
    ...
    TLDConfig(
        tld="us",
        rdap_endpoint="https://rdap.nic.us/domain/",
        whois_server="whois.nic.us",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="ca",
        rdap_endpoint="https://rdap.ca.fury.ca/rdap/domain/",
        whois_server="whois.cira.ca",
        whois_enabled=True,
    ),
    TLDConfig(
        tld="au",
        rdap_endpoint="https://rdap.auda.org.au/domain/",
    ...
    TLDConfig(
        tld="in",
        rdap_endpoint="https://rdap.registry.in/domain/",
    ...
    TLDConfig(
        tld="br",
        rdap_endpoint="https://rdap.registro.br/domain/",
